...
void ADC_Calibration(void)
{
	...
	//    calibration:
	//    ï¿½ Set the calibration mode bit CALMODE.
	//    ï¿½ Write a divider value to the CLKDIV bit field that divides the system
	//      clock to yield an ADC clock of about 500 kHz.
	//    ï¿½ Clear the LPWR bit.
	...
	*/
	...
	{	
		...
		*/
		...
		while (coinadder >= 50){ // STOP WHEELS AFTER 20 COINS
